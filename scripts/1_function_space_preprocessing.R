...
functions_simple_10_numerics <- read_feather("Data/functions_simple_10_numerics_pp.feather")
functions_simple_10_numerics <- functions_simple_10_numerics[1:36, ]
# Load spatial predictors
source("Scripts/Functions/FSO_functions.R")
spatial_predictors <- load_sp_wflow(scale = TRUE, na.approx = FALSE)
